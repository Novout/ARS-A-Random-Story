...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "1100.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NCountry = {
	...
	WAR_SUPPORT_DEFENSIVE_WAR = 0.15,				-- Impact of being in defensive war
	...
	POLITICAL_POWER_CAP = 1200.0,					-- Max amount of political power country should have
...
NProduction = {
	...
	MAX_LINE_RESOURCE_PENALTY = 30,		-- Max penalty factor for production lines lacking strategic resources in %.
	RESOURCE_PENALTY_WARNING_CRITICAL_RATIO = 0.6, -- Switch to red progress bar if penalty is over threshold 
	...
	PRODUCTION_RESOURCE_LACK_PENALTY = -0.35,			-- Penalty decrease while lack of resource per factory
...
NTechnology = {
	...
	BASE_TECH_COST = 140,					-- Base cost for a tech. multiplied with tech cost and ahead of time penalties
...
NPolitics = {
	...
	BASE_POLITICAL_POWER_INCREASE = 4.2,	-- Weekly increase of PP.
...
NBuildings = {
	...
	INFRASTRUCTURE_RESOURCE_BONUS = 0.25, -- multiplactive resource bonus for each level of (non damaged) infrastructure
},
...
NMilitary = {
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 10,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	LEADER_SKILL_FACTOR = 0.06,                    -- bonus per skill level of leader
...
NAI = {
	...
	FOCUS_TREE_CONTINUE_FACTOR = 1.0,			-- Factor for score of how likely the AI is to keep going down a focus tree rather than starting a new path.
...
NFocus = {
	FOCUS_POINT_DAYS = 7.0,						-- Each point takes a week
